...
$('.EnviarFormulario').click(function(){   
    ...
    if(NombreFormularioLog==""){
        ...
        $('.cajaCertificado').append(' <p class="NombreEstudiante">'+NombreFormularioLog+' <p class="CodigoSecreto">'+" "+' '+"("+''+NumeroDeCaracteres+''+")"+'</p></p>')
       if(window.innerWidth>300 && window.innerWidth<530  ){
           $('.NombreEstudiante').css({"font-size":"18px"});
           $('.NombreEstudiante').css({"top":"42%"});
